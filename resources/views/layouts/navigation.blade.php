    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('prisioner.management')"
                        :active="request()->routeIs('prisioner.management')">
                        {{ __('Detentos') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('visitor.management')" :active="request()->routeIs('visitor.management')">
                        {{ __('Visitantes') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('employee.management')"
                        :active="request()->routeIs('employee.management')">
                        {{ __('Funcionários') }}
                    </x-nav-link>
                </div>
