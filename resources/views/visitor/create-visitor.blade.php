                    ...
                    <form method="POST" action="{{ route('visitor.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="phone" name="phone" value="{{ old('phone') }}"
                                class="mt-1 focusring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md">
                        </div>
                        <div class="mb-4">
                            <label for="email"
                        ...
                        <a href="{{ route('visitor.management') }}"
                            class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Calcelar</a>
                        <button type="submit"
